...
final class SwitchPanel extends JPanel {
    ...
    private void wrapInSwitch() {
        ...
        canvas.getUndoManager().start("Wrap in Switch");
        try {
    ...
    private void addAlternative() {
        ...
        canvas.getUndoManager().start("Add Switch Alternative");
        try {
    ...
    private void updateLanguage() {
        ...
        canvas.getUndoManager().start("Update Switch Language");
        try {
            if (after.isEmpty()) {
                cachedElement.removeAttribute("systemLanguage");
            } else {
                cachedElement.setAttribute("systemLanguage", after);
            }
        } finally {
            canvas.getUndoManager().end();
        }
    ...
    private void removeAlternative() {
        ...
        canvas.getUndoManager().start("Remove Switch Alternative");
        try {
    ...
    private void extractFromSwitch() {
        ...
        canvas.getUndoManager().start("Extract from Switch");
        try {
