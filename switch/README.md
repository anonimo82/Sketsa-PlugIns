...
- `switch-0.2.16.nbm` — installable NBM built from this source revision.
- `README.md` — this file.

## Plug-in summary

- SVG switch/language editor.
- The main feature set is functional.
- Undo/Redo is intentionally left incomplete for one language-selection/simulation path.

## Undo / Redo status

Known limitation: selecting/focusing a language without committing a persistent Switch change can leave Undo falling through to the previous canvas operation. This build is not certified for Undo/Redo.
...
Install `switch-0.2.16.nbm` using the Sketsa 9.1 plug-in/module manager.
