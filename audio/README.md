...
- `audio-0.16.12.nbm` — installable NBM built from this source revision.
- `README.md` — this file.

## Plug-in summary

- Audio metadata/editor support.
- Contextual suggestions for buses, trigger sources/types, event IDs, and trigger actions.
- Dynamic values are read from the current SVG document.
...
Install `audio-0.16.12.nbm` using the Sketsa 9.1 plug-in/module manager.
