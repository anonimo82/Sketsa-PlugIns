...
- `text-spacing-0.3.15.nbm` — installable NBM built from this source revision.
- `README.md` — this file.

## Plug-in summary

- Letter-spacing and word-spacing editor.
- Undo/Redo restores the SVG text styling.
- After Undo/Redo, the UI controls are synchronized back to the actual document values.

## Undo / Redo status

Validated in user testing, including UI synchronization after Undo/Redo.
...
Install `text-spacing-0.3.15.nbm` using the Sketsa 9.1 plug-in/module manager.
