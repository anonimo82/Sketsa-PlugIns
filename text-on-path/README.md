...
- `text-on-path-0.1.10.nbm` — installable NBM built from this source revision.
- `README.md` — this file.

## Plug-in summary

- Text-on-path editor.
- The path field can list <path> IDs dynamically from the current SVG document.
...
Install `text-on-path-0.1.10.nbm` using the Sketsa 9.1 plug-in/module manager.
