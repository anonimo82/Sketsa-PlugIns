...
- `physics-0.9.16.nbm` — installable NBM built from this source revision.
- `README.md` — this file.

## Plug-in summary

- Physics metadata/editor support.
- Contextual suggestions for constraint targets and physics event IDs.
- Dynamic values are read from IDs currently available in the SVG document.
...
Install `physics-0.9.16.nbm` using the Sketsa 9.1 plug-in/module manager.
