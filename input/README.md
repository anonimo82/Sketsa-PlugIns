...
- `input-0.8.10.nbm` — installable NBM built from this source revision.
- `README.md` — this file.

## Plug-in summary

- Input/control metadata editor.
- Contextual suggestions for control types, actions, target sources, target actions, target IDs, and target events.
- Target IDs are discovered from the current SVG document.
...
Install `input-0.8.10.nbm` using the Sketsa 9.1 plug-in/module manager.
