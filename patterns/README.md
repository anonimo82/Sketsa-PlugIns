...
- `patterns-0.3.7.nbm` — installable NBM built from this source revision.
- `README.md` — this file.

## Plug-in summary

- SVG pattern editor.
- Undo/Redo transaction handling was corrected so pattern edits are tracked independently.
...
Install `patterns-0.3.7.nbm` using the Sketsa 9.1 plug-in/module manager.
